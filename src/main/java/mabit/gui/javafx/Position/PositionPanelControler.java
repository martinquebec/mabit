 ...
 */
public class PositionPanelControler implements EventHandler<FxOrderEvent> {
    private static final Logger Log = Logger.getLogger(PositionPanelControler.class);
    final ObservableList<TableMapRow> data;

    public PositionPanelControler(ObservableList<TableMapRow> data) {
        this.data = data;
        init();
    }

    public PositionPanelControler() {
